...
class TransaksiFragment : Fragment() {
    ...
    private lateinit var my_cart : kotlin.collections.ArrayList<Cart>
    ...
    override fun onCreateView(
        ...
        btnBayar.setOnClickListener{
            ...
            //Perintah untuk mengarah ke bayarFragment
...
private fun Bundle.putParcelableArrayList(s: String, myCart: Array<Cart>) {
